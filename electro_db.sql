...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3508263025ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=electro_db&table=interruption">`electro_db`.`interruption`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=power_app&table=bill_generate">`power_app`.`bill_generate`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=electro_db&table=efectedcustomer">`electro_db`.`efectedcustomer`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=elecro_task_db&table=customer">`elecro_task_db`.`customer`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=elecro_task_db&table=employee">`elecro_task_db`.`employee`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=elecro_task_db&table=task_workers">`elecro_task_db`.`task_workers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=items">`test`.`items`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=elecro_task_db&table=task">`elecro_task_db`.`task`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=electro_db&table=Interruption">`electro_db`.`Interruption`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=electrogriddb&table=task_workers">`electrogriddb`.`task_workers`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6b6a486d3d355d5e73634930672e5b5c">
